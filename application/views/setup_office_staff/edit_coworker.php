                ...
                <div class="col-xs-12">
                    ...
                    foreach($office_staffs as $offices_staff)
                    {
                        if(is_array($offices_staff))
                        {
                            ...
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" name="coworkers[]" value="<?php echo $office_staff['id']; ?>" <?php if(in_array($office_staff['id'],$assigned_coworker)){echo 'checked';} ?>><?php echo $office_staff['name'].' - '.$office_staff['employee_id'].' '.'('.$office_staff['designation_name'].')'; ?>
                                </label>
                            </div>
                        <?php
                        }
