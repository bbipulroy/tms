                ...
                foreach($office_staffs as $office_staff)
                {
                    ...
                    <div class="checkbox">
                        <label title="<?php echo $office_staff['name']; ?>">
                            <input type="checkbox" name="coworkers[]" value="<?php echo $office_staff['id']; ?>" <?php if(in_array($office_staff['id'],$assigned_coworker)){echo 'checked';} ?>><?php echo $office_staff['name']; ?>
                        </label>
                    </div>
                <?php
                }
